//
//  FountainFireworkController.swift
//  Swift-FireWork
//
...
public class FountainFireworkController {
    ...
    //
    public func addFirework(sparks sparksCount: Int, above sourceView: UIView, sparkSize: CGSize = CGSize(width: 9, height: 9), scale: CGFloat = 45.0, offsetY:CGFloat = 0, animationDuration: TimeInterval = 0.7) {
        ...
        for sparkIndex in 0..<sparksCount {
            ...
            self.scheduler.schedule(sparks: [spark], in: superview, with: FontainFireworkAnimator(), animationDuration: animationDuration)
